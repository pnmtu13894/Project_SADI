...
import com.minhtu.firebaseproject.Detail_Activity;
...
/**
 * Created by minhtu on 5/6/17.
 */

public class CustomerAdapter extends RecyclerView.Adapter<Holder>{
    private Context c;
    private ArrayList<Shoes> shoesList;


    public CustomerAdapter(Context c, ArrayList<Shoes> shoesList) {
        this.c = c;
    ...
    public void onBindViewHolder(Holder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                openDetailActivity(shoes.getShoesID(), shoes.getName(), shoes.getPrice(), shoes.getDescription(), shoes.getBrand(), shoes.getImageUrl());
            }
        });
    }

    private void openDetailActivity(String shoesID, String name, float price, String description, String brand, String imageUrl) {

        Intent intent = new Intent(c, Detail_Activity.class);
